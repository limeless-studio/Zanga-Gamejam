...
{
    [CreateNodeMenu("Data/Reader")]
    public class DataReaderNode : Node, IContextual, ICacheable {
        ...
        public void UpdateData<T>() {
            ...
            foreach (FieldInfo fieldInfo in fieldInfos) {
                ...
                NodePort newPort = AddDynamicOutput(serializableFieldInfo.Type, Node.ConnectionType.Multiple, TypeConstraint.None, serializableFieldInfo.PortName);
            ...
            foreach (PropertyInfo propertyInfo in propertyInfos) {
                ...
                NodePort newPort = AddDynamicOutput(serializablePropertyInfo.Type, Node.ConnectionType.Multiple, TypeConstraint.None, serializablePropertyInfo.PortName);
